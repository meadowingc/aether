...
config :aether, Aether.Repo,
  database: Path.expand("../aether_dev.db", __DIR__),
  pool_size: 5,
  stacktrace: true,
...
config :aether, AetherWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "ud7TD9gGiAKscuRB+FdNFY1Tr1sQodIPqsh4BUTyZXYTrWT8U6yelSiDt0FTZRrD",
  watchers: [
...
config :aether, AetherWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/aether_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]
